...
repo init --depth 1 -u  https://github.com/RyuOS-Org/manifest.git -b 16 --git-lfs
rm -rf .repo/local_manifests && git clone https://github.com/SourceLab081/local_manifests --depth 1 -b 16-RyuOS .repo/local_manifests
echo "repo sync"
/opt/crave/resync.sh
# signing key
...
lunch ryuos_fog-bp2a-userdebug
#breakfast fog eng
#lunch aicp_fog-eng
