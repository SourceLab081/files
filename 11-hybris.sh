...
#cd ../..
wget https://github.com/SourceLab081/uploadz/releases/download/v0.0.2/patches.zip;mkdir -p external/chromium-webview/patches;unzip patches.zip -d  external/chromium-webview/patches;rm pathes.zip 
